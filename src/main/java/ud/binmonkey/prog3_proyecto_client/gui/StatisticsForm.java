...
public class StatisticsForm {
    ...
    private JLabel timeSpentField;
    private JLabel genresLabel;
    private JLabel genresField;
    private JLabel averageRatingLabel;
    private JLabel averageRatingField;
    private JLabel ratedPercentageLabel;
    private JLabel ratedPercentageField;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public StatisticsForm() {
        ...
        /* Initial Display */
        displayRatings();
        timeSpentField.setText(String.valueOf(mySQL.getTimeWatched()) + " minutes");
...
//                mySQL.getUserTitleList("user_viewing_history").size()) * 100) + " %");
    ...
    private void displayRatings() {
        for (String id : mySQL.getTitleList("user_ratings")) {
            ...
            Object[] data = {neo4j.getAttribute(id, "title"), neo4j.getType(id),
    ...
    private void $$$setupUI$$$() {
        ...
        timeSpentLabel.setText("Label");
        personalPanel.add(timeSpentLabel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
