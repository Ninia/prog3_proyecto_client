...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public LibraryForm() {
        ...
        showTitles(MediaType.ALL, "title", ".* *."); /* Shows All */ /* TODO move wildcard to method */
        ...
        resetButton.addActionListener(actionEvent -> {
            ...
            showTitles(MediaType.ALL, "title", ".* *."); /* TODO move wildcard to method */
    ...
    public void addTitle(String id, String poster, String title) {
    ...
    private void showTitles(MediaType type, String condition, String value) {

        for (ArrayList<String> title : neo4j.getTitles(type, condition, value)) {
