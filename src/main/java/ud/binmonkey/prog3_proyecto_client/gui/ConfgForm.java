...
public class ConfgForm {
    ...
    public ConfgForm() {
        ...
        $$$setupUI$$$();
        httpsclientHostTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "https-client", "host").getTextContent());
        httpsclientPortTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "https-client", "port").getTextContent());
        ftpHostTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "ftp", "host").getTextContent());
        ftpPortTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "ftp", "port").getTextContent());
        neo4jserverAddressTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "neo4j-server", "server_address").getTextContent());
        neo4jserverUsernameTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "neo4j-server", "username").getTextContent());
        neo4jserverPasswordTf.setText(DocumentReader.getAttr(DocumentReader.getDoc("conf/properties.xml"),
                "network", "neo4j-server", "password").getTextContent());
    ...
    private void $$$setupUI$$$() {
        ...
        networkJLabel.setIconTextGap(4);
        networkJLabel.setInheritsPopupMenu(true);
        ...
        PrJPanel.add(spacer5, new GridConstraints(0, 4, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        httpsclientHostTf.setEditable(false);
        ...
        httpsclientPortTf.setEditable(false);
        ...
        testclientPortTf.setEditable(false);
        ...
        neo4jserverAddressTf.setEditable(false);
        ...
        neo4jserverUsernameTf.setEditable(false);
        ...
        neo4jserverPasswordTf.setEditable(false);
        ...
        PrJPanel.add(spacer8, new GridConstraints(5, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer9 = new Spacer();
        PrJPanel.add(spacer9, new GridConstraints(6, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer10 = new Spacer();
        PrJPanel.add(spacer10, new GridConstraints(8, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer11 = new Spacer();
        PrJPanel.add(spacer11, new GridConstraints(10, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer12 = new Spacer();
        PrJPanel.add(spacer12, new GridConstraints(11, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer13 = new Spacer();
        PrJPanel.add(spacer13, new GridConstraints(12, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer14 = new Spacer();
        PrJPanel.add(spacer14, new GridConstraints(3, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer15 = new Spacer();
        PrJPanel.add(spacer15, new GridConstraints(7, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer16 = new Spacer();
        PrJPanel.add(spacer16, new GridConstraints(9, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer17 = new Spacer();
        PrJPanel.add(spacer17, new GridConstraints(4, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer18 = new Spacer();
        PrJPanel.add(spacer18, new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer19 = new Spacer();
        PrJPanel.add(spacer19, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer20 = new Spacer();
        PrJPanel.add(spacer20, new GridConstraints(9, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer21 = new Spacer();
        PrJPanel.add(spacer21, new GridConstraints(7, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final Spacer spacer22 = new Spacer();
        PrJPanel.add(spacer22, new GridConstraints(4, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
    }
